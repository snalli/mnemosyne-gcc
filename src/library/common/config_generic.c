...
static inline int env_setting_lookup(char *group, char *member, char **value_str) {
...
static inline int env_setting_lookup_int(char *group, char *member, int *value) {
    char *value_str;
...
static inline int env_setting_lookup_bool(char *group, char *member, int *value) {
    return env_setting_lookup_int(group, member, value);
}

static inline int env_setting_lookup_string(char *group, char *member, char **value) {
...
int m_config_setting_lookup_string(config_t *cfg, char *group_name, char *member_name, char **value,
    ...
    if (env_setting_lookup_string(group_name, member_name, &val) == CONFIG_TRUE) {
        ...
        group = config_lookup(cfg, group_name);
        if (group &&
            config_setting_lookup_string(group, member_name, (const char **)&val) == CONFIG_TRUE) {
            found_val = 1;
        }
    }
