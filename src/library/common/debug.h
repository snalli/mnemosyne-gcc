...
#define M_INTERNALERROR(msg, ...)                                                                  \
    m_debug_print(__FILE__, __LINE__, 1, "Internal Error: ", msg, ##__VA_ARGS__)

#define M_ERROR(msg, ...) m_debug_print(NULL, 0, 1, "Error", msg, ##__VA_ARGS__)

#ifdef _M_BUILD_DEBUG

#define M_WARNING(msg, ...) m_debug_print(NULL, 0, 0, "Warning", msg, ##__VA_ARGS__)

#define M_DEBUG_PRINT(debug_level, msg, ...) m_debug_print_L(debug_level, msg, ##__VA_ARGS__)
