...
/* 0x0000100000000000 (256 TiB) exceeds ARM64 48-bit user VA.
 * Use 0x0000200000000000 (32 TiB) which fits in 46-bit: valid on
 * x86_64 (47-bit user VA) and ARM64 (48-bit user VA). */
#define PSEGMENT_RESERVED_REGION_START 0x0000200000000000
...
#define SEGMENT_TABLE_END PAGE_ALIGN(SEGMENT_TABLE_START + SEGMENT_TABLE_HOLE + SEGMENT_TABLE_SIZE)
/* Log pool */
#define LOG_POOL_START SEGMENT_TABLE_END
#define LOG_POOL_SIZE (32 * 16 * 1024 * 1024 + 32 * 32 * 64)
#define LOG_POOL_HOLE 0x10000
#define LOG_POOL_END PAGE_ALIGN(LOG_POOL_START + LOG_POOL_HOLE + LOG_POOL_SIZE)
