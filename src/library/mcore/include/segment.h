...
struct m_segidx_entry_s {
    ...
    uint64_t module_id; /**< valid for .persistent sections only. Identifies the module the
                           .persistent section belongs to */
...
struct m_segidx_s {
    ...
    m_segidx_entry_t mapped_entries; /**< the head of the mapped segments list; we keep this list
                                        ordered by start address; no overlaps allowed */
