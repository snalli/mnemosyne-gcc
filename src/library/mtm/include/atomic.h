...
static inline int _mtm_cas(volatile atomic_t *a, atomic_t expected, atomic_t desired) {
    return __atomic_compare_exchange_n(a, &expected, desired, 0, __ATOMIC_SEQ_CST,
                                       __ATOMIC_SEQ_CST);
}
...
#define ATOMIC_FETCH_ADD_FULL(a, v)                                                                \
    __atomic_fetch_add((volatile atomic_t *)(a), (v), __ATOMIC_SEQ_CST)
#ifdef SAFE
...
#define ATOMIC_STORE_REL(a, v)                                                                     \
    __atomic_store_n((volatile atomic_t *)(a), (atomic_t)(v), __ATOMIC_SEQ_CST)
...
#define ATOMIC_STORE_REL(a, v)                                                                     \
    __atomic_store_n((volatile atomic_t *)(a), (atomic_t)(v), __ATOMIC_RELEASE)
#define ATOMIC_STORE(a, v)                                                                         \
    __atomic_store_n((volatile atomic_t *)(a), (atomic_t)(v), __ATOMIC_RELAXED)
