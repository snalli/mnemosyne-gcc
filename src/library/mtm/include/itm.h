...
extern _ITM_TRANSACTION_PURE _ITM_transaction *_ITM_CALL_CONVENTION _ITM_getTransaction(void);

extern _ITM_TRANSACTION_PURE _ITM_howExecuting _ITM_CALL_CONVENTION _ITM_inTransaction();

extern _ITM_TRANSACTION_PURE int _ITM_CALL_CONVENTION _ITM_getThreadnum(void);

extern _ITM_TRANSACTION_PURE void _ITM_CALL_CONVENTION _ITM_addUserCommitAction(
    _ITM_userCommitFunction __commit, _ITM_transactionId resumingTransactionId, void *__arg);

extern _ITM_TRANSACTION_PURE void _ITM_CALL_CONVENTION
_ITM_addUserUndoAction(const _ITM_userUndoFunction __undo, void *__arg);

extern _ITM_TRANSACTION_PURE _ITM_transactionId _ITM_CALL_CONVENTION _ITM_getTransactionId();

extern _ITM_TRANSACTION_PURE void _ITM_CALL_CONVENTION _ITM_dropReferences(const void *__start,
                                                                           size_t __size);

extern _ITM_TRANSACTION_PURE void _ITM_CALL_CONVENTION _ITM_userError(const char *errString,
                                                                      int exitCode);
...
extern void _ITM_CALL_CONVENTION _ITM_error(const _ITM_srcLocation *__src, int errorCode);

extern uint32_t _ITM_beginTransaction(uint32_t __properties, ...) __attribute__((returns_twice));
extern void _ITM_CALL_CONVENTION _ITM_commitTransaction(void);

extern bool _ITM_CALL_CONVENTION _ITM_tryCommitTransaction(const _ITM_srcLocation *__src);

extern void _ITM_CALL_CONVENTION _ITM_commitTransactionToId(const _ITM_transactionId tid,
                                                            const _ITM_srcLocation *__src);

extern void _ITM_CALL_CONVENTION _ITM_abortTransaction(_ITM_abortReason __reason,
                                                       const _ITM_srcLocation *__src);

extern void _ITM_CALL_CONVENTION _ITM_rollbackTransaction(const _ITM_srcLocation *__src);

extern void _ITM_CALL_CONVENTION _ITM_registerThrownObject(const void *__obj, size_t __size);

extern void _ITM_CALL_CONVENTION _ITM_changeTransactionMode(_ITM_transactionState __mode,
