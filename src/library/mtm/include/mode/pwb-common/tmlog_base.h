...
static inline m_result_t m_tmlog_base_write(pcm_storeset_t *set, m_tmlog_base_t *tmlog,
...
static inline m_result_t m_tmlog_base_begin(m_tmlog_base_t *tmlog) {
    return M_R_SUCCESS;
}

static inline m_result_t m_tmlog_base_commit(pcm_storeset_t *set, m_tmlog_base_t *tmlog,
                                             uint64_t sqn) {
    m_phlog_base_t *phlog_base = &(tmlog->phlog_base);
...
static inline m_result_t m_tmlog_base_abort(pcm_storeset_t *set, m_tmlog_base_t *tmlog,
                                            uint64_t sqn) {
    m_phlog_base_t *phlog_base = &(tmlog->phlog_base);
...
static inline m_result_t m_tmlog_base_truncate_sync(pcm_storeset_t *set, m_tmlog_base_t *tmlog) {
