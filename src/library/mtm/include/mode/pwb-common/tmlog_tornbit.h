...
static inline m_result_t m_tmlog_tornbit_write(pcm_storeset_t *set, m_tmlog_tornbit_t *tmlog,
                                               uintptr_t addr, pcm_word_t val, pcm_word_t mask) {
...
static inline m_result_t m_tmlog_tornbit_begin(m_tmlog_tornbit_t *tmlog) {
    return M_R_SUCCESS;
}

static inline m_result_t m_tmlog_tornbit_commit(pcm_storeset_t *set, m_tmlog_tornbit_t *tmlog,
                                                uint64_t sqn) {
    m_phlog_tornbit_t *phlog_tornbit = &(tmlog->phlog_tornbit);
...
static inline m_result_t m_tmlog_tornbit_abort(pcm_storeset_t *set, m_tmlog_tornbit_t *tmlog,
                                               uint64_t sqn) {
    m_phlog_tornbit_t *phlog_tornbit = &(tmlog->phlog_tornbit);
...
static inline m_result_t m_tmlog_tornbit_truncate_sync(pcm_storeset_t *set,
