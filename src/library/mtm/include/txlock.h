...
__attribute__((transaction_pure)) static inline int m_txmutex_init(m_txmutex_t *txmutex) {
...
__attribute__((transaction_pure)) static inline int m_txmutex_destroy(m_txmutex_t *txmutex) {
    pthread_mutex_t *mutex = (pthread_mutex_t *)txmutex;

    return pthread_mutex_destroy(mutex);
}

__attribute__((noinline)) static void breakme() {}

__attribute__((transaction_pure)) static inline int m_txmutex_lock(m_txmutex_t *txmutex) {
    pthread_mutex_t *mutex = (pthread_mutex_t *)txmutex;
    int ret;
...
__attribute__((transaction_pure)) static inline int m_txmutex_unlock(m_txmutex_t *txmutex) {
    int ret;
    pthread_mutex_t *mutex = (pthread_mutex_t *)txmutex;
...
__attribute__((transaction_pure)) static inline int m_txrwlock_init(m_txrwlock_t *txrwlock) {
    pthread_rwlock_t *rwlock = (pthread_rwlock_t *)txrwlock;

    return pthread_rwlock_init(rwlock, NULL);
}

__attribute__((transaction_pure)) static inline int m_txrwlock_destroy(m_txrwlock_t *txrwlock) {
    pthread_rwlock_t *rwlock = (pthread_rwlock_t *)txrwlock;

    return pthread_rwlock_destroy(rwlock);
}

__attribute__((transaction_pure)) static inline int m_txrwlock_rdlock(m_txrwlock_t *txrwlock) {
    pthread_rwlock_t *rwlock = (pthread_rwlock_t *)txrwlock;
...
__attribute__((transaction_pure)) static inline int m_txrwlock_wrlock(m_txrwlock_t *txrwlock) {
    pthread_rwlock_t *rwlock = (pthread_rwlock_t *)txrwlock;
...
__attribute__((transaction_pure)) static inline int m_txrwlock_unlock(m_txrwlock_t *txrwlock) {
    int ret;
    pthread_rwlock_t *rwlock = (pthread_rwlock_t *)txrwlock;
