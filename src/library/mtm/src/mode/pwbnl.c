 ...
 */
void mtm_pwbnl_store(mtm_tx_t *tx, volatile mtm_word_t *addr, mtm_word_t value) {
 ...
 */
void mtm_pwbnl_store2(mtm_tx_t *tx, volatile mtm_word_t *addr, mtm_word_t value, mtm_word_t mask) {
 ...
 */
mtm_word_t mtm_pwbnl_load(mtm_tx_t *tx, volatile mtm_word_t *addr) {
