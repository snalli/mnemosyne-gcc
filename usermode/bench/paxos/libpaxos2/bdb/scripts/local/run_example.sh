...
#xterm -geometry 80x24+10+10 -e "cd $PROJ_DIR;  gdb ./example_acceptor 0; $KEEP_XTERM_OPEN" &
...
xterm -geometry 80x8+10+600 -e "cd $PROJ_DIR; ./benchmark_client -s 10 -M 5000 -p 1000 -d 10; $KEEP_XTERM_OPEN" &
