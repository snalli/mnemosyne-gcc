...
TM_CALLABLE int sendbuf_add_accept_ack_lexical(udp_send_buffer * sb, acceptor_record * rec, int state);
...
TM_CALLABLE int sendbuf_add_prepare_ack_lexical(udp_send_buffer * sb, acceptor_record * rec, int state);
