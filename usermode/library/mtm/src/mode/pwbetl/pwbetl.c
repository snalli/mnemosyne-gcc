...
mtm_vtable_t STR2 (mtm_pwbetl, _vtable) =
{
	FOREACH_OUTER_FUNCTION (DEFINE_VTABLE_MEMBER, mtm_pwbetl_)
	_GEN_READ_BARRIERS_LIST (mtm_pwbetl_R, mtm_pwbetl_R, mtm_pwbetl_R, mtm_pwbetl_RfW)
	_GEN_WRITE_BARRIERS_LIST (mtm_pwbetl_W, mtm_pwbetl_W, mtm_pwbetl_W)
	_ITM_FOREACH_MEMCPY (DEFINE_VTABLE_MEMBER, STR2 (mtm_pwbetl, _))
	_ITM_FOREACH_LOG_TRANSFER (DEFINE_VTABLE_MEMBER, mtm_local_)
	_ITM_FOREACH_MEMSET (DEFINE_VTABLE_MEMBER, STR2 (mtm_pwbetl, _))
	_ITM_FOREACH_MEMMOVE (DEFINE_VTABLE_MEMBER, STR2 (mtm_pwbetl, _))
};
