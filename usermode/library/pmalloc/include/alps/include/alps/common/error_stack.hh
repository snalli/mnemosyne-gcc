...
#ifndef _ALPS_COMMON_ERROR_STACK_HH_
#define _ALPS_COMMON_ERROR_STACK_HH_
...
#include "alps/common/compiler.hh"
#include "alps/common/assert_nd.hh"
#include "alps/common/cxx11.hh"
 ...
 * @def ERROR_STACK(e)
 * @ingroup ERRORCODES
 * @brief Instantiates ErrorStack with the given alps::error_code,
