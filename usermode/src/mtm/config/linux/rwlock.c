...
static int
rwlock_lock_summary (mtm_rwlock *lock)
{
	int o;
...
void
mtm_rwlock_read_lock (mtm_rwlock *lock)
{
	int o;
	int n;
...
void
mtm_rwlock_write_lock (mtm_rwlock *lock)
{
	int o;
	int n;
...
bool
mtm_rwlock_write_upgrade (mtm_rwlock *lock)
{
	int o;
	int n;
...
void
mtm_rwlock_read_unlock (mtm_rwlock *lock)
{
  int o;
...
void
mtm_rwlock_write_unlock (mtm_rwlock *lock)
{
  int o;
